...
// DIAPER POO CONSTANTS
//COLOR
#define TYPE_DIAPERS_POOP_COLOR_YELLOW @"YELLOW"
#define TYPE_DIAPERS_POOP_COLOR_BROWN @"BROWN"
#define TYPE_DIAPERS_POOP_COLOR_GREEN @"GREEN"
#define TYPE_DIAPERS_POOP_COLOR_BLACK @"BLACK"
//TEXUTRE
